...
bool MainApp::Initialize()
{
	...
	// m_Graphics 객체 초기화.
	mSceneView->Initialize(screenWidth, screenHeight, m_hwnd);
...
LRESULT CALLBACK MainApp::MessageHandler(HWND hwnd, UINT umsg, WPARAM wparam, LPARAM lparam)
{
	switch (umsg)
	{
		// 키보드가 눌러졌는가 처리
...
void MainApp::InitializeWindows(int& screenWidth, int& screenHeight)
{
	// 외부 포인터를 이 객체로 지정합니다
