...
{
	mShaderType = SHADERTYPE::SKY;
}

bool SkyShader::InitializeShader(ID3D11Device* device, HWND hwnd, const TCHAR* vsFilename, const TCHAR* psFilename)
{
...
bool SkyShader::UpdateShader(ID3D11DeviceContext* deviceContext)
{
